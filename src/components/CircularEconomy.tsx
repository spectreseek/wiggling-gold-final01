      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-muted-foreground leading-relaxed animate-fade-in">
            <p>
              Wiggling Gold Ghana is pioneering the <strong className="text-foreground font-semibold">circular economy</strong> in West Africa. We tackle the growing problem of organic waste accumulation by employing nature's most efficient converters: the <strong className="text-foreground font-semibold">Black Soldier Fly (BSF) larvae</strong>.
            </p>
